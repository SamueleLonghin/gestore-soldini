...
@gestionebp.route("/gestione/<file_id>", methods=["GET"])
@login_is_required
def gestione(file_id):
    ...
    return render_template(
        "dashboard.html", spese=spese, file_id=file_id, title=title, categorie=categorie
    )


@gestionebp.route("/gestione/<file_id>/spese", methods=["GET", "POST"])
@login_is_required
def spese(file_id):
    title = get_spreadsheet_name(file_id)
    spese = get_spese_from_file(file_id)
...
@gestionebp.route("/gestione/<file_id>/aggiungi_spesa", methods=["GET"])
@login_is_required
...
@gestionebp.route("/gestione/<file_id>/aggiungi_spesa", methods=["POST"])
@login_is_required
...
@gestionebp.route("/gestione/<file_id>/ingressi", methods=["GET"])
@login_is_required
...
@gestionebp.route("/gestione/<file_id>/salva_data_ingresso", methods=["POST"])
@login_is_required
...
@gestionebp.route("/gestione/<file_id>/modifica_ingresso", methods=["POST"])
@login_is_required
...
@gestionebp.route("/gestione/<file_id>/aggiungi_ingresso", methods=["POST"])
@login_is_required
